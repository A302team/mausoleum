...
#include "GameData/Events/PersonalEvents/PersonalEventPurifyingFlameDefinition.h"
#include "GameData/Items/ItemDefinition.h"
#include "GamePlay/Items/BaseItem.h"

void UPersonalEventPurifyingFlame::ExecuteEvent_Implementation(AMyCharacter* InstigatorCharacter)
{
...
void UPersonalEventPurifyingFlame::OnEventResolved_Implementation(AMyCharacter* InstigatorCharacter, int32 ChoiceIndex)
{
	(void)ChoiceIndex;
