...
void UPersonalEventAnothersPortrait::ExecuteEvent_Implementation(AMyCharacter* InstigatorCharacter)
{
...
void UPersonalEventAnothersPortrait::OnEventResolved_Implementation(AMyCharacter* InstigatorCharacter, int32 ChoiceIndex)
{
	(void)ChoiceIndex;
