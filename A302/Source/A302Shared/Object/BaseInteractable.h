...
private:
	...
	void Multicast_PlayDisappearVFX(FVector Location, FRotator Rotation, class UNiagaraSystem* VFXSystem, float Scale, class USoundBase* Sound, float VolumeMultiplier);
};
